    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-6 py-10">
        <div className="mb-6 flex items-center justify-between">
          <h1 className="text-lg font-semibold text-neutral-900">Seat maps</h1>
        ...
        {seatMaps === null ? (
          ...
          <div className="mb-8 flex flex-col gap-3">
            {seatMaps.length === 0 && (
              <p className="text-sm text-neutral-500">No seat maps yet.</p>
            )}
            {seatMaps.map((sm) => (
                ...
                <Card className="flex items-center justify-between hover:border-brand-300">
                  <div>
                    <div className="flex items-center gap-2">
                      <h2 className="font-medium text-neutral-900">{sm.name}</h2>
        ...
        <Card>
          <h2 className="mb-3 font-medium text-neutral-900">+ New seat map</h2>
